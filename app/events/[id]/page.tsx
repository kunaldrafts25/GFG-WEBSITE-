...
interface EventData {
    ...
    registrationCount: number; isPast: boolean; whatsappLink?: string
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        {event.whatsappLink && (
                            <Card className="border-none shadow-md overflow-hidden bg-gradient-to-r from-green-500/10 to-green-600/5 dark:from-green-500/20 dark:to-green-600/10">
                                <CardContent className="pt-6">
                                    <a
                                    ...
                                    >
                                        <div className="h-12 w-12 rounded-full bg-green-500 flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
                                        ...
                                        <div className="flex-1">
                                            <p className="font-semibold text-foreground group-hover:text-green-600 transition-colors">Join WhatsApp Community</p>
                                            <p className="text-xs text-muted-foreground">Get updates & connect with attendees</p>
                                        </div>
